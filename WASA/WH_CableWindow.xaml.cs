...
{
    /// <summary>
    /// Логика взаимодействия для WH_CableWindow.xaml
    /// </summary>
    public partial class WH_CableWindow : Window
    {
        private static GlobalData globalData = new GlobalData();
        private static FileIOService fileIOService = new FileIOService();
        private ObservableCollection<WareHouseModel> _warehouse_data = fileIOService.LoadObservableData(globalData.GetDataPath("Cable_Data.json"));
        private BindingList<WareHouseModel> _tempdata = fileIOService.LoadTempData();
        
        public WH_CableWindow()
        {
            InitializeComponent();
        ...
        {
            WH_CableWindowEdit wH_CableWindowEdit = new WH_CableWindowEdit();
            wH_CableWindowEdit.Show();
            Close();
        }
