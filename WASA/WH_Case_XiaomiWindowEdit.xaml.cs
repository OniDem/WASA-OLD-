...
{
    /// <summary>
    /// Логика взаимодействия для WH_Case_XiaomiWindowEdit.xaml
    /// </summary>
    public partial class WH_Case_XiaomiWindowEdit : Window
    {
        private static GlobalData globalSettings = new GlobalData();
        private readonly string PATH = globalSettings.GetDataPath("Case_Xiaomi_Data.json");
        ...
        public WH_Case_XiaomiWindowEdit()
        {
            InitializeComponent();
        }
