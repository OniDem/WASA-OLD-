...
namespace WASA
{
    ...
    public partial class WH_AudioWindow : Window
    {
        private static GlobalData globalData = new GlobalData();
        private static FileIOService fileIOService = new FileIOService();
        private ObservableCollection<WareHouseModel> _warehouse_data = fileIOService.LoadObservableData(globalData.GetDataPath("Audio_Data.json"));
        private BindingList<WareHouseModel> _tempdata = fileIOService.LoadTempData();
        
        public WH_AudioWindow()
        {
            InitializeComponent();
        ...
        {
            WH_AudioWindowEdit wH_AudioWindowEdit = new WH_AudioWindowEdit();
            wH_AudioWindowEdit.Show();
            Close();
        }
