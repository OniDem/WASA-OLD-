...
{
    /// <summary>
    /// Логика взаимодействия для WH_CaseWindowEdit.xaml
    /// </summary>
    public partial class WH_Case_SamsungWindowEdit : Window
    {
        private static GlobalData globalSettings = new GlobalData();
        private readonly string PATH = globalSettings.GetDataPath("Case_Samsung_Data.json");
        ...
        public WH_Case_SamsungWindowEdit()
        {
            InitializeComponent();
        }
