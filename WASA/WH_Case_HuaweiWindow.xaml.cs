...
{
    /// <summary>
    /// Логика взаимодействия для WH_Case_HuaweiWindow.xaml
    /// </summary>
    public partial class WH_Case_HuaweiWindow : Window
    {
        private static GlobalData globalData = new GlobalData();
        private static FileIOService fileIOService = new FileIOService();
        private ObservableCollection<WareHouseModel> _warehouse_data = fileIOService.LoadObservableData(globalData.GetDataPath("Case_Huawei_Data.json"));
        private BindingList<WareHouseModel> _tempdata = fileIOService.LoadTempData();
       

        public WH_Case_HuaweiWindow()
        {
            InitializeComponent();
        ...
        {
            WH_Case_HuaweiWindowEdit wH_Case_HuaweiWindowEdit = new WH_Case_HuaweiWindowEdit();
            wH_Case_HuaweiWindowEdit.Show();
            Close();
        }
