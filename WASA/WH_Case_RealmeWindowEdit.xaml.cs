...
{
    /// <summary>
    /// Логика взаимодействия для WH_Case_RealmeWindowEdit.xaml
    /// </summary>
    public partial class WH_Case_RealmeWindowEdit : Window
    {
        private static GlobalData globalSettings = new GlobalData();
        private readonly string PATH = globalSettings.GetDataPath("Case_Realme_Data.json");
        ...
        public WH_Case_RealmeWindowEdit()
        {
            InitializeComponent();
        }
