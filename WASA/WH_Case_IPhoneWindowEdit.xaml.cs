...
{
    /// <summary>
    /// Логика взаимодействия для WH_Case_IPhoneWindowEdit.xaml
    /// </summary>
    public partial class WH_Case_IPhoneWindowEdit : Window
    {
        private static GlobalData globalSettings = new GlobalData();
        private readonly string PATH = globalSettings.GetDataPath("Case_IPhone_Data.json");
        ...
        public WH_Case_IPhoneWindowEdit()
        {
            InitializeComponent();
        }
